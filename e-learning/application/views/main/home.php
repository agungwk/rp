...
<?php
  if(isset($this->session->userdata('data')['foto'])){
    if($this->session->userdata('data')['foto'] != "" || $this->session->userdata('data')['foto'] != null){
        if($this->session->userdata('data')['type'] == "member"){

      $urlImage = base_url()."assets/file/murid/".$this->session->userdata('data')['foto'];
          }else{
...
?>
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><h4>Kauruh</h4></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if($this->session->userdata('data')['type'] != "instruktur"){ ?><li><a href="<?php echo base_url() ?>"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li><?php } ?>
