            ...
            <form role="form" class="form-horizontal" action="<?php echo base_url() ?>guru/profile/updateData" method="post" enctype="multipart/form-data">
              <div class="box-body">
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                          <label class=" control-label">Account Skype</label>
                          <div class="controls">
                        ...
                        <div class="form-group">
                          <label class=" control-label">Pengalaman Pribadi</label>
                          <div class="controls">
                        ...
                        <div class="form-group">
                          <label class=" control-label">Rekening (Nama Bank, Account Bank dan Nama)</label>
                          <div class="controls">
                        ...
                        <div class="form-group">
                          <label class=" control-label">Input Biodata atau CV</label>
                          <div class="controls">
                            <input type="file" name="file" class="form-control">
                            <span style="color: red;">*File extention must .zip atau .rar size 5Mb</span>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="controls">
                            ...
                            <span style="color: red;">*File extention must .jpg atau .png </span>
                          </div>
                        </div>
                    </div>
