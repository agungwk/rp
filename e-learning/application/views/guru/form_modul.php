            ...
            <form role="form" class="form-horizontal" action="<?php echo base_url() ?>guru/modul/<?=$url;?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="mata_pelajaran" required="required" class="form-control" value="<?php echo $mata_pelajaran?>" placeholder="Jenis Pelatihan">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="modul" required="required" class="form-control" value="<?php echo $modul?>" placeholder="Nama Pelatihan">
                  </div>
                </div>
                <div class="form-group">
