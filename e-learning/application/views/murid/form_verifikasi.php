...
<script src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-WWv51W6Syne83sdX"></script>
           ...
           <!-- <form class="text-center" role="form" action="<?php echo base_url() ?>murid/verifikasi/saveData" method="post" enctype="multipart/form-data"> !-->
			...
			<!--<input name="PAYMENTCHANNEL" type="hidden" value="15" > !-->
              ...
              <div class="box-footer">
                ...
                <button type="button" id="paynow" class="btn btn-primary">Bayar Sekarang</button>
    ...
    <script type="text/javascript">
      document.getElementById('paynow').onclick = function(){
        ...
        {
          transaction_details: {
            gross_amount: <?=$data_belajar->harga; ?>,
            // as example we use timestamp as order ID
            order_id: "<?=$data_belajar->no_invoice; ?>"
          }
        }
