	...
	<nav class="fh5co-nav" role="navigation">
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 text-right">
						...
						<p class="num">Phone: +6221 222 7894 | Fax: +6221 222 7956</p>
		...
		<div class="top-menu">
			<div class="container">
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo"><a href="index.php"><i class="icon-study"></i>Lima Pilar<span></span></a></div>
					</div>
    ...
    <div id="own_wrapper">
        ...
        if(isset($_GET['param'])){
           $parameter = $_GET['param']; 
            ...
            switch($parameter){
                case 'home':
                    include('pages/home_teacher.php');
                    break;
                default:
                    include('pages/home_teacher.php');
                    break;
		...
		<div class="container">
			<div class="row row-pb-md">
				<div class="col-md-6 fh5co-widget">
					<h3>Kontak Kami</h3>
                        <li>Telepon : +62 222 7894</li>
                        <li>Fax : +62 222 7956</li>
                        <li><a href="#" target="_blank">Email : info@tsicertification.co.id</a></li>
			...
			<div class="row copyright">
				<div class="col-md-12 text-center">
					<p>
						<small class="block">&copy; 2017 lpm. All Rights Reserved.</small> 
						<small class="block">Designed by <a href="http://freehtml5.co/" target="_blank">Andreas Donny</a> Demo Images: <a href="http://unsplash.co/" target="_blank">Unsplash</a> &amp; <a href="https://www.pexels.com/" target="_blank">Pexels</a></small>
					</p>
				</div>
			</div>
