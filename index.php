...
<html>
	...
	<title>Rumah Pengembangan e-Training</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="Rumah Pengembangan Website by www.rumahpengembangan.com - LPM e-Training"/>
	<meta name="keywords" content="Rumah Pengembangan Website by www.rumahpengembangan.com - LPM e-Training"/>
	<meta name="author" content="www.rumahpengembangan.com" />
	...
	RUMAH PENGEMBANGAN TEMPLATE 
	DESIGNED & DEVELOPED by andreas.co.id
		
	Website: 		http://rumahpengembangan.com/
	Email: 			info@rumahpengembangan.com
	...
	<nav class="fh5co-nav" role="navigation">
				...
				<div class="row">
					<div class="col-xs-12 text-right">
						...
						<ul class="fh5co-social">
							<li><a href="https://www.facebook.com/Rumah-Pengembangan-5-Pilar-1932387297013093/" target="_blank"><i class="icon-facebook2"></i></a></li>
							<li><a href="https://twitter.com/5_rumah" target="_blank"><i class="icon-twitter2"></i></a></li>
							...
							<li><a href="whatsapp://send?text=Message!" target="_blank"><i class="icon-whatsapp"></i></a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="top-menu">
			<div class="container">
				<div class="row">
					<div class="col-xs-2">
						<!--<div id="fh5co-logo"><a href="index.php"><i class="icon-home"></i>Rumah Pengembangan<span></span></a></div> !-->
						<img src ="assets/theme_images/Logo_Rp_2 (2).ico">
					</div>
	...
	<footer id="fh5co-footer" style="padding: 15px" role="contentinfo" style="background-image: url(assets/theme_images/img_bg_4.jpg);">
		...
		<div class="container">
			<div class="row row-pb-md">
				<div class="col-md-6 fh5co-widget">
					<h3>Kontak Kami</h3>
                        ...
                        <li><a href="http://rumahpengembangan.com/" target="_blank">Website : www.rumahpengembangan.com</a></li>
                        <li><a href="#" target="_blank">Email : info@rumahpengembangan.com</a></li>
			...
			<div class="row copyright">
				<div class="col-md-12 text-center">
					<p>
						<small class="block">&copy; 2017 Rumah Pengembangan lpm e-Training. All Rights Reserved.</small> 
